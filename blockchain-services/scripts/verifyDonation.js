...
const TX_HASH = process.argv[2] || "0x74b79ba4862f0df40c243e816fa638bcc3164e9a4de8f40982d412139e6f6c37";
...
async function verifyDonation() {
    ...
    try {
        ...
        receipt.logs.forEach((log) => {
            try {
                ...
                if (parsed && parsed.name === "DonationRecorded") {
                    ...
                    console.log("💰 Amount (PHP):", parsed.args.amount.toString());
                    console.log("🏘️  Barangay ID:", parsed.args.barangayId);
                    console.log("📦 Type:", parsed.args.donationType === 0 ? "Monetary" : "In-Kind");
        ...
        console.log("");
        console.log("🔗 Explorer:", `https://sepolia-blockscout.lisk.com/tx/${TX_HASH}`);
        console.log("");
        console.log(found ? "✅ Donation is VERIFIED on blockchain" : "⚠️  Could not parse donation data");
