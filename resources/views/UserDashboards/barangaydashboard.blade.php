                    ...
                    <tbody id="onlineDonationsList">
                        <tr>
                            <td colspan="5" class="px-4 py-12 text-center text-gray-500">
                                No online donations yet. This will be populated when Carl's module is integrated.
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="quantity" required class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="e.g., 50 kilos, 100 pieces, 20 box">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Item Description *</label>
                            <textarea name="items_description" required rows="3" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Please describe the items being donated..."></textarea>
                        </div>
                        <div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Any special instructions or notes..."></textarea>
                        </div>
                    </div>
                </div>
...
<!-- MODAL 3: Distribution Modal (UPDATED WITH PHOTO UPLOAD) -->
            ...
            <form id="distributeForm" class="p-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="distribution_date" value="<?php echo date('Y-m-d'); ?>" required class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <!-- Photo Preview Grid -->
                    <div id="photoPreviewGrid" class="grid grid-cols-5 gap-2 mt-4 hidden">
...
// <!-- MODAL: View Distribution Details (FIXED) -->
            ...
            <form id="needForm" class="p-6">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="quantity" required class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="e.g., 500 family packs, 1000 liters">
                    </div>
                    <div>
 ...
 // ==================== LOAD PHYSICAL DONATIONS (UPDATED BUTTONS) ====================
                    ...
                    tbody.innerHTML = `
                        <tr>
                            <td colspan="5" class="px-4 py-12 text-center text-gray-500">
                                ...
                                <p class="text-sm mt-2">Blockchain-verified donations will appear here.</p>
                            </td>
                        </tr>
                    `;
                }
        ...
        // ==================== MARK COMPLETE ====================
        async function markComplete(donationId) {
            if (!confirm('Mark this donation as fully distributed?')) return;
            ...
            try {
                const response = await fetch(`/api/bdrrmc/physical-donations/${donationId}/distribute`, {
                    ...
                    body: JSON.stringify({
                        distributed_to: 'General Distribution',
                        quantity_distributed: 'All items',
                ...
                if (result.success) {
                    alert('Marked as fully distributed!');
                    loadPhysicalDonations();
                }
            } catch (error) {
                console.error('Error:', error);
                alert('Error updating distribution status.');
            }
        }

        function viewDistribution(donationId) {
            alert('View distribution history for donation #' + donationId);
        }
      ...
      // ==================== EDIT STATUS MODAL ====================
        ...
        // Update the distribute form submission
        const originalDistributeSubmit = document.getElementById('distributeForm').onsubmit;
        document.getElementById('distributeForm').addEventListener('submit', async function(e) {
            e.preventDefault();
        ...
        async function removeNeed(needId) {
            if (!confirm('Remove this fulfilled request from the list? This action cannot be undone.')) return;
        ...
        function openPartialDistributeModal(donationId, trackingCode) {
            ...
            // Pre-select "partially_distributed"
        ...
        async function viewDonationDetails(donationId) {
            // Use the same function as view distribution
