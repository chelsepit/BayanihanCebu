...
<div class="bg-white rounded-lg shadow-lg p-8 mb-6">
    ...
    <div class="flex items-center justify-between mb-6 pb-6 border-b">
        ...
        <div class="text-right">
            <span class="px-4 py-2 bg-<?php echo e($donation->status_color); ?>-100 text-<?php echo e($donation->status_color); ?>-800 font-semibold rounded-full">
        ...
        <div>
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-gray-800"><?php echo e(ucfirst($donation->donation_type)); ?></span>
                </div>
                <div class="flex justify-between">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold text-gray-800"><?php echo e($donation->donor_display_name); ?></span>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between">
                    ...
                    <span class="px-2 py-1 bg-<?php echo e($donation->disaster->severity_color); ?>-100 text-<?php echo e($donation->disaster->severity_color); ?>-800 text-xs font-semibold rounded">
                        <?php echo e(ucfirst($donation->disaster->severity)); ?>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-blue-700 font-mono break-all">
                        TX: <?php echo e($donation->transaction_hash); ?>
    ...
    <!-- Distribution Info -->
    <?php if($donation->distributed_at): ?>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-green-800 mb-2">
                        Distributed on <?php echo e($donation->distributed_at->format('M d, Y \a\t h:i A')); ?>

                    </p>
                    <?php if($donation->distribution_notes): ?>
                        <p class="text-sm text-green-700"><?php echo e($donation->distribution_notes); ?></p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600"><?php echo e($donation->created_at->format('M d, Y \a\t h:i A')); ?></p>
                </div>
            </div>

            <!-- Confirmed -->
            <?php if(in_array($donation->status, ['confirmed', 'distributed', 'completed'])): ?>
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0">
                        <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Distributed -->
            <?php if(in_array($donation->status, ['distributed', 'completed'])): ?>
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0">
                        <div class="w-10 h-10 bg-green-500 rounded-full flex items-center justify-center">
                            <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-sm text-gray-600"><?php echo e($donation->distributed_at?->format('M d, Y \a\t h:i A')); ?></p>
                    </div>
                </div>
            <?php else: ?>
                <div class="flex items-start gap-4">
...
</div><?php /**PATH C:\Users\Judd\BayanihanCebuBackEnd\resources\views\donations\partials\track-legacy.blade.php ENDPATH**/ ?>